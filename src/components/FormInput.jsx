...
class FormInput extends React.Component {
    ...
    render() {
        return (
            <form className="px-5 sm:px-28 py-6 md:py-14" onSubmit={this.onSubmitEventHandler}>
                <div className="container">
                    <div className="mb-6">
                        <label htmlFor="title" className="block mb-2 text-lg font-medium text-gray-800">
                            Judul : <span className='text-sm text-gray-600'>{this.state.limit - this.state.title.length} sisa karakter</span>
                        </label>
